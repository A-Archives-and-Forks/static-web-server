...
This new `v2.43.0` brings bug fixes, new features and improvements. A fix for unnecessary pre-compressed file lookups, FIPS-capable TLS support via a new Cargo feature and prebuilt binaries, performance optimizations, hardening across several modules, byte-range suffix detection and extract normalization, and other improvements.
...
- [f503ee1][f503ee1] Byte-range suffix detection and extract normalization helpers. PR [#674][674] by [@joseluisq][joseluisq]
...
- [dc2c7a2][dc2c7a2] CI: update release GitHub Actions workflows for FIPS builds (follow-up). PR [#689][689] (also [#688][688]) by [@joseluisq][joseluisq]

**Docs**

- [f93f80e][f93f80e] Add missing FIPS docker images and binary descriptions. PR [#687][687] by [@joseluisq][joseluisq]
- [6dc9798][6dc9798] Add missing `.html` suffix for `404`s description. PR [#686][686] by [@joseluisq][joseluisq]
